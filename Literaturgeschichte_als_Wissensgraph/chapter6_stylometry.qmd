...
![Distanzmaße: Manhattan-Distanz, Euklidische Distanz und Kosinus-Distanz [Stefan Evert, 2017. Lizenziert unter Creative Commons Namensnennung 4.0 International (CC-BY)]](evert_jannidis_schoch_2016.png){#fig-distance-measures}
...
![Bibliographischer Eintrag 84.50 zu *L’étourdi* (Martin / Mylne / Frautschi 1977: 272).](etourdi.JPG){#fig-etourdi}
...
![Stilometrische Untersuchung von roman18 mit stylo, Wurzburg distance, 2000 MFW.](wurzburg_distance_2000MFW.jpg){#fig-wurzburg-distance}
...
![PCA(Principal Components Analysis) mit Loadings](150_MFW_pca_loadings.png){#fig-pca-loadings}
...
![Stilometrische Analyse mit erweiterten Datensatz, 3500 MFW, Wurzburg distance.](with_neufville_montador.jpg){#fig-with-neufville} 
...
![Bootstrap consensus tree, Wurzburg distance, 2000-4000 MFW.](bootstrap_consensus_tree_with_neufville.jpg){#fig-bootstrap-neufville}
...
![Preferred rank, normal rank und deprecated rank in Wikibase (MiMoTextBase)](ranks_wikibase.png){#fig-ranks}
